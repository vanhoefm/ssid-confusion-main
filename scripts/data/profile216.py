...
Config.instname = "Technion - Electrical Engineering Faculty"
Config.profilename = "ef-secure"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "pcfarm@ee.technion.ac.il"
Config.title = "eduroam CAT"
Config.server_match = "td-ef-main.ef.technion.ac.il"
...
Config.ssids = ['ef-secure']
Config.del_ssids = []
Config.servers = ['DNS:td-ef-main.ef.technion.ac.il']
