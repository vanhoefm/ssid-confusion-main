...
Config.instname = "lux future lab"
Config.profilename = "futureLab Corporate"
Config.url = "https://www.easywifi.lu"
Config.email = "helpdesk@hotcity.lu"
Config.title = "eduroam CAT"
Config.server_match = "authenticator.hotcity.lu"
...
Config.user_realm = "luxfuturelab.lu"
Config.ssids = ['futureLab Corporate']
Config.del_ssids = []
Config.servers = ['DNS:authenticator.hotcity.lu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@luxfuturelab.lu"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
