...
Config.instname = "Badische Landesbibliothek"
Config.profilename = "BLB-sWLAN"
Config.url = " \
    ""http://www.blb-karlsruhe.de/blb/blbhtml/benutzung/wlan.php"
Config.email = "wlan@blb-karlsruhe.de"
Config.title = "eduroam CAT"
Config.server_match = "radius1.blb-karlsruhe.de"
...
Config.ssids = ['BLB-sWLAN']
Config.del_ssids = []
Config.servers = ['DNS:radius1.blb-karlsruhe.de']
