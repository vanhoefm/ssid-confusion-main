...
Config.instname = "Gymnasium Lerbermatt (SchülerInnen)"
Config.profilename = ""
Config.url = "http://www.lerbermatt.ch/dienste/informatikdienste"
Config.email = "informatikdienste@lerbermatt.ch"
Config.title = "eduroam CAT"
Config.server_match = "ad.lerbermatt.ch"
...
Config.user_realm = "lerbermatt.ch"
Config.ssids = ['lerbermatt-students']
Config.del_ssids = []
Config.servers = ['DNS:radius.ad.lerbermatt.ch', 'DNS:radius1.ad.lerbermatt.ch', 'DNS:radius2.ad.lerbermatt.ch']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@lerbermatt.ch"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
