...
Config.instname = "Studenten Internet"
Config.profilename = "STUDENTENINTERNET(EAP)"
Config.url = "www.studenteninternet.be"
Config.email = "support@studenteninternet.be"
Config.title = "eduroam CAT"
Config.server_match = "authentic.be"
...
Config.ssids = ['STUDENTENINTERNET(EAP)']
Config.del_ssids = []
Config.servers = ['DNS:authentic.smarteye.be', 'DNS:authentic.studenteninternet.be']
