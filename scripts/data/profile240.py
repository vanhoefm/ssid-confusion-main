...
Config.instname = "HyperMesh"
Config.profilename = "HyperMesh"
Config.url = "hypermesh.net"
Config.email = "admin@hypermesh.net"
Config.title = "eduroam CAT"
Config.server_match = "radius.hypermesh.ml"
...
Config.user_realm = "hypermesh.net"
Config.ssids = ['HyperMesh']
Config.del_ssids = []
Config.servers = ['DNS:radius.hypermesh.ml']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
