...
Config.instname = "University of Cambridge Computer Laboratory"
Config.profilename = "Internal-CL"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "sys-admin@cl.cam.ac.uk"
