...
Config.instname = "RLS26"
Config.profilename = "Pofilname"
...
Config.server_match = "moon.rls26.de"
...
Config.user_realm = "rls26.de"
Config.ssids = ['PEAP', 'WIFI']
Config.del_ssids = []
Config.servers = ['DNS:moon.rls26.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@rls26.de"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

7UOz1Jf45KW5/9wg
-----END CERTIFICATE-----
"""
#run_installer()
