...
Config.instname = "WiggyNet"
Config.profilename = "WiggyNet"
Config.url = "https://wiggynet.gq"
Config.email = "admin@wiggynet.gq"
Config.title = "eduroam CAT"
Config.server_match = "WiggyNet"
...
Config.ssids = ['WiggyNet']
Config.del_ssids = []
Config.servers = ['DNS:WiggyNet']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

RyzuHLbF8cqC3inYMv7NEbZVlL0WV92oFpIyP1SM
-----END CERTIFICATE-----
"""
#run_installer()
