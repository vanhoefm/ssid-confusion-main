...
Config.instname = "Théâtre de l'Œuvre / Association La Paix"
Config.profilename = "Théâtre de l'Œuvre / Association La Paix · " \
    "WiFi Organisation"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "getintouchwith@jonathanphoto.fr"
...
Config.ssids = ['theatre_org']
Config.del_ssids = []
Config.servers = ['DNS:home.jonathanphoto.fr', 'DNS:theatre-oeuvre.com']
