...
Config.instname = "Selfnet"
Config.profilename = "Selfnet W-LAN"
Config.url = "https://selfnet.de"
Config.email = "support@selfnet.de"
Config.title = "eduroam CAT"
Config.server_match = "server.selfnet.de"
...
Config.user_realm = "radius-user.selfnet.de"
Config.ssids = ['Selfnet']
Config.del_ssids = []
Config.servers = ['DNS:radius-user-1.server.selfnet.de', 'DNS:radius-user-2.server.selfnet.de']
