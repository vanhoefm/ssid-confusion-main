...
Config.instname = "Scalar Solutions"
Config.profilename = "Scalar Employees"
Config.url = "www.scalar.com.au"
Config.email = "support@scalar.com.au"
Config.title = "eduroam CAT"
Config.server_match = "SS01.scalar.local"
...
Config.ssids = ['Scalar_Radius']
Config.del_ssids = []
Config.servers = ['DNS:SS01.scalar.local']
Config.use_other_tls_id = False
Config.tou = """To use this network you have to be a Scalar Employee!"""
Config.CA = """-----BEGIN CERTIFICATE-----

lTx+NnrF
-----END CERTIFICATE-----
"""
#run_installer()
