...
Config.instname = "The Great Room Offices"
Config.profilename = "TGR Members"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "it@thegreatroomoffices.com"
Config.title = "eduroam CAT"
Config.server_match = "radius.meraki.com"
...
Config.ssids = ['@The Great Room Offices']
Config.del_ssids = []
Config.servers = ['DNS:radius.meraki.com']
