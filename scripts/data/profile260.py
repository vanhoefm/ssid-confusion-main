...
Config.instname = "d7-airlan"
Config.profilename = "Domus7"
Config.url = "https://wiki.d7.whka.de/tut/internet/start"
Config.email = "d7-netz@lists.kit.edu"
Config.title = "eduroam CAT"
Config.server_match = "auth.d7.whka.de"
...
Config.user_realm = "d7.whka.de"
Config.ssids = ['d7-airlan']
Config.del_ssids = []
Config.servers = ['DNS:auth.d7.whka.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@d7.whka.de"
Config.tou = ""
