...
Config.instname = "Kuleuven"
Config.profilename = "campusroam"
Config.url = "https://admin.kuleuven.be/icts/english/servicedesk"
Config.email = "servicedesk@icts.kuleuven.be"
Config.title = "eduroam CAT"
Config.server_match = "radius.kuleuven.be"
...
Config.user_realm = "facclub.be"
Config.ssids = ['campusroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.kuleuven.be']
