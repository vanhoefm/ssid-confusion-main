...
Config.instname = "Silicon Hill, SU ČVUT"
Config.profilename = "WiFi6"
Config.url = "https://wiki.sh.cvut.cz/klub/itsluzby/wifi"
Config.email = "kancelar@sh.cvut.cz"
Config.title = "eduroam CAT"
Config.server_match = "ldap.sh.cvut.cz"
...
Config.ssids = ['SiliconHill6']
Config.del_ssids = ['SH_registrace']
Config.servers = ['DNS:ldap.sh.cvut.cz']
