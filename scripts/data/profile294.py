...
Config.instname = "Now Coworking"
Config.profilename = "Now Coworking"
Config.url = "https://coworker.now-coworking.com"
Config.email = "your local Enterprise Wi-Fi support"
Config.title = "eduroam CAT"
Config.server_match = "nowcoworking-radius.quantic-telecom.net"
...
Config.ssids = ['Now Coworking - 8021x']
Config.del_ssids = ['Now Coworking']
Config.servers = ['DNS:nowcoworking-radius.quantic-telecom.net', 'DNS:nowcoworking-radius.quantic-telecom.net']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
