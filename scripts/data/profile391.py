...
Config.instname = "IOBobbioStudenti"
Config.profilename = ""
...
Config.server_match = "Reti Bobbio"
...
Config.user_realm = "bobbio.istruzioneer.it"
Config.ssids = ['IOBobbioStudenti']
Config.del_ssids = []
Config.servers = ['DNS:Reti Bobbio']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

0Nifwvrq
-----END CERTIFICATE-----
"""
#run_installer()
