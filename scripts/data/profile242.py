...
Config.instname = "Technical university of Liberec"
Config.profilename = "TULext-20190312"
Config.url = "https://tulext.tul.cz"
Config.email = "your local Enterprise Wi-Fi support"
Config.title = "eduroam CAT"
Config.server_match = "tul.cz"
...
Config.user_realm = "ext.tul.cz"
Config.ssids = ['TULext']
Config.del_ssids = ['eduroam']
Config.servers = ['DNS:radius1.tul.cz', 'DNS:radius2.tul.cz']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ext.tul.cz"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----
MIIEAjCCAuqgAwIBAgIBATANBgkqhkiG9w0BAQsFADCBmjELMAkGA1UEBhMCQ1ox
...

-----END CERTIFICATE-----
"""
#run_installer()
