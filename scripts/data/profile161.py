...
Config.instname = "Educacion-GN"
Config.profilename = "Educacion"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "cau@educacion.navarra.es"
Config.title = "eduroam CAT"
Config.server_match = "educacion.navarra.es"
...
Config.ssids = ['Educacion']
Config.del_ssids = []
Config.servers = ['DNS:clearpass1.educacion.navarra.es', 'DNS:clearpass2.educacion.navarra.es', 'DNS:clearpass3.educacion.navarra.es', 'DNS:clearpass4.educacion.navarra.es']
