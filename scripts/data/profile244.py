...
Config.instname = "Tomasz W SENSE"
Config.profilename = "PEAP"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "tw2529@gmail.com"
Config.title = "eduroam CAT"
Config.server_match = "radius.supplicants.net"
...
Config.user_realm = "user346.supplicants.net"
Config.ssids = ['SENSE']
Config.del_ssids = []
Config.servers = ['DNS:radius.supplicants.net']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@user346.supplicants.net"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
