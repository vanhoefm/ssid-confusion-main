...
Config.instname = "Suffield Academy"
Config.profilename = "SA Students and Faculty"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "auto@help.suffieldacademy.org"
Config.title = "eduroam CAT"
Config.server_match = "dot1x-auth-2024.suffieldacademy.org"
...
Config.ssids = ['Suffield Auth']
Config.del_ssids = []
Config.servers = ['DNS:dot1x-auth-2024.suffieldacademy.org']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

BUClWd6hCgBnG36m5LWG
-----END CERTIFICATE-----
"""
#run_installer()
