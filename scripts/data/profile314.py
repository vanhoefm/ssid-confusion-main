...
Config.instname = "Fachschaftsrat Elektrotechnik der TU Dresden"
Config.profilename = ""
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "admins@fsr.et.tu-dresden.de"
Config.title = "eduroam CAT"
Config.server_match = "padme.fsr.et.tu-dresden.de"
...
Config.ssids = ['FSRET']
Config.del_ssids = []
Config.servers = ['DNS:padme.fsr.et.tu-dresden.de']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
