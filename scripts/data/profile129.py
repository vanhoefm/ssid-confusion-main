...
Config.instname = "MU Enpresagintza"
Config.profilename = "Ikasleak"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "admins@eteo.mondragon.edu"
Config.title = "eduroam CAT"
Config.server_match = "SEOVDCAPOLO.mondragon.edu"
...
Config.del_ssids = []
Config.servers = ['DNS:SEOVDCAPOLO.mondragon.edu']
