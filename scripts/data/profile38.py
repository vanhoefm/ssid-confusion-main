...
Config.server_match = "Auth.stelify"
...
Config.ssids = ['secureTest']
Config.del_ssids = []
Config.servers = ['DNS:Auth.stelify']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
