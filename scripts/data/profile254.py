...
Config.instname = "VECTIGALIS Ltd"
Config.profilename = "Employees"
Config.url = "https://id.vectigalis.si/"
Config.email = "it@vectigalis.si"
Config.title = "eduroam CAT"
Config.server_match = "radius.vectigalis.si"
...
Config.user_realm = "vectigalis.si"
Config.ssids = ['VECTIGALIS-Corp']
Config.del_ssids = ['VECTIGALIS-Office']
Config.servers = ['DNS:radius.vectigalis.si']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@vectigalis.si"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
