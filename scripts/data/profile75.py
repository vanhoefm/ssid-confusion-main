...
Config.instname = "Test 5"
Config.profilename = "test5"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "help@arvutiarst.ee"
Config.title = "eduroam CAT"
Config.server_match = "10.100.1.45"
...
Config.ssids = ['test5']
Config.del_ssids = []
Config.servers = ['DNS:10.100.1.45']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
