...
Config.instname = "hobex AG"
Config.profilename = "hobex"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "it@hobex.at"
Config.title = "eduroam CAT"
Config.server_match = "srv-raduis.hobex.local"
...
Config.ssids = ['cpwl']
Config.del_ssids = []
Config.servers = ['DNS:srv-raduis.hobex.local']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
