...
Config.instname = "Odyssys"
Config.profilename = "GlobalReach"
Config.url = "https://globalreachtech.com"
Config.email = "your local Enterprise Wi-Fi support"
Config.title = "eduroam CAT"
Config.server_match = "odyssys.net"
...
Config.user_realm = "odyssys.net"
Config.ssids = []
Config.del_ssids = []
Config.servers = ['DNS:odyssys.net']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@odyssys.net"
Config.tou = ""
