...
Config.instname = "n0emis.eu (KeksKruemel)"
Config.profilename = "KeksKruemel"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "support@n0emis.eu"
Config.title = "eduroam CAT"
Config.server_match = "auth.n0emis.eu"
...
Config.ssids = ['KeksKruemel']
Config.del_ssids = []
Config.servers = ['DNS:auth.n0emis.eu']
