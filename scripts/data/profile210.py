...
Config.instname = "Fondazione IES"
Config.profilename = "IES Students"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "manzoro@fondazioneies.it"
Config.title = "eduroam CAT"
Config.server_match = "IES Certificate Authority"
...
Config.ssids = ['IES-STU']
Config.del_ssids = []
Config.servers = ['DNS:IES Certificate Authority']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
