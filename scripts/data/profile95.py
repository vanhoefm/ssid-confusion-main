...
Config.instname = "Juan Pablo 2"
Config.profilename = "juanpablo2"
Config.url = "http://www.gruposanvalero.es/"
Config.email = "mantenimiento@cpasalduie.com"
Config.title = "eduroam CAT"
Config.server_match = "sv_radius"
...
Config.ssids = ['juanpablo2']
Config.del_ssids = []
Config.servers = ['DNS:sv_radius']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

DQyshB/4cNkNt9r0qZ+glz3A/Cs0G2BelFqSxSxZDEB9MbheTUGVPR9X
-----END CERTIFICATE-----
"""
#run_installer()
