...
Config.instname = "Kwame Nkrumah University of Science and Technology"
Config.profilename = "KNUST WIFI+"
Config.url = "http://uits.knust.edu.gh"
Config.email = "noc@knust.edu.gh"
Config.title = "eduroam CAT"
Config.server_match = "KNUST Radius Certificate Authority"
...
Config.ssids = ['KNUST WIFI+']
Config.del_ssids = []
Config.servers = ['DNS:KNUST Radius Certificate Authority']
