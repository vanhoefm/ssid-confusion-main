...
Config.instname = "Instituto Federal de Educação Ciência de " \
    "Tecnologia do Rio Grande do Norte - IFRN"
Config.profilename = "wIFRN-Corp"
...
Config.server_match = "laserena.ifrn.local"
...
Config.user_realm = "ifrn.edu.br"
Config.ssids = ['wIFRN-Corp']
Config.del_ssids = []
Config.servers = ['DNS:laserena.ifrn.local']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

jTxT2zeVrV2WCaVbf12TZM+Lzdkk9p5+MMrblWxRCcoEJZ0W
-----END CERTIFICATE-----
"""
#run_installer()
