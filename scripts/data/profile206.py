...
Config.instname = "VillageOffice Cooperative"
Config.profilename = ""
...
Config.server_match = "radius.villageoffice.ch"
...
Config.ssids = ['VillageOffice']
Config.del_ssids = []
Config.servers = ['DNS:radius.villageoffice.ch']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

Xm2YdrzLNhCJOhBJSKoHxlr6aTv07Dq1rgQS6AD4xZ83JlZQUkBxOVDY
-----END CERTIFICATE-----
"""
#run_installer()
