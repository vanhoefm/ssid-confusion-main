...
Config.instname = "UiTM WiFi Services"
Config.profilename = "UiTM WiFi STUDENT"
Config.url = "https://wifi.uitm.edu.my"
Config.email = "wifi@uitm.edu.my"
Config.title = "eduroam CAT"
Config.server_match = "wifistudent.uitm.edu.my"
...
Config.ssids = ['UiTM WiFi STUDENT']
Config.del_ssids = []
Config.servers = ['DNS:wifistudent.uitm.edu.my']
