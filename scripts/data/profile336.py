...
Config.instname = "UES Universidad de El Salvador FMOcc"
Config.profilename = "Empleados y estudiantes FMOcc"
...
Config.server_match = "nas3.occ.ues.edu.sv"
...
Config.ssids = ['occEmpleados', 'occEstudiantes', 'uesoccEmpleados', 'uesoccEstudiantes']
Config.del_ssids = []
Config.servers = ['DNS:nas3.occ.ues.edu.sv']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

ZYDUO6x5O+GvGPYq135Oxx2cM0Qb
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----
MIIEYTCCA0mgAwIBAgIJANHm/06RJ9K/MA0GCSqGSIb3DQEBBQUAMIHGMQswCQYD
VQQGEwJTVjESMBAGA1UECAwJU2FudGEgQW5hMSMwIQYDVQQKDBpVbml2ZXJzaWRh
