...
Config.instname = "Morehead State University"
Config.profilename = "MMC"
Config.url = "http://www.moreheadstate.edu"
Config.email = "z.ori@moreheadstate.edu"
Config.title = "eduroam CAT"
Config.server_match = "morehead-st.edu"
...
Config.ssids = ['MSU_SECURE']
Config.del_ssids = []
Config.servers = ['DNS:alph.morehead-st.edu', 'DNS:ralph.morehead-st.edu']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
