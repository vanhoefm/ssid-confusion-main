...
Config.instname = "Studentersamfundet i Trondhjem"
Config.profilename = "Samfundet WLAN"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "itk@samfundet.no"
Config.title = "eduroam CAT"
Config.server_match = "wlan.samfundet.no"
...
Config.user_realm = "SAMFUNDET.NO"
Config.ssids = ['Samfundet.1x']
Config.del_ssids = []
Config.servers = ['DNS:wlan.samfundet.no']
Config.use_other_tls_id = False
Config.anonymous_identity = "eduroam@SAMFUNDET.NO"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
