...
Config.ssids = ['amonet::connect']
Config.del_ssids = []
Config.servers = ['DNS:10.0.0.1']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
