...
Config.instname = "Premium Business Support Mk II Ltd."
Config.profilename = "Staff"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "help@business.example"
Config.title = "eduroam CAT"
Config.server_match = "network-auth.business.example"
...
Config.ssids = ['PREMISES']
Config.del_ssids = []
Config.servers = ['DNS:network-auth.business.example']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

FxLFU6HCk3X3
-----END CERTIFICATE-----
"""
#run_installer()
