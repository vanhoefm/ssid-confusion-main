...
Config.instname = "Viatelecome Network"
Config.profilename = "Profil bezpieczenstwa"
Config.url = "helpdesk.viatelecome.pl"
Config.email = "serwis@viatelecome.pl"
Config.title = "eduroam CAT"
Config.server_match = "viatelecome"
...
Config.ssids = ['ViaNet']
Config.del_ssids = ['temporarynet']
Config.servers = ['DNS:viatelecome']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
