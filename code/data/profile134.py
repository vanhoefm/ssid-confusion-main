...
Config.instname = "Max Planck Institute for the Physics of Complex " \
    "Systems MPIPKS"
Config.profilename = "MPIPKS internal"
Config.url = " \
    ""https://www.mpipks-dresden.mpg.de/institute/infrastructure/it/"
Config.email = "support@pks.mpg.de"
Config.title = "eduroam CAT"
Config.server_match = "pks-members.mpipks-dresden.mpg.de"
...
Config.ssids = ['pks-members']
Config.del_ssids = ['pks-guest']
Config.servers = ['DNS:pks-members.mpipks-dresden.mpg.de']
