...
Config.instname = "ICT-Samenwerking"
Config.profilename = "WiFi Govroam"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "servicedesk@doetinchem.nl"
Config.title = "eduroam CAT"
Config.server_match = "PKI Doetinchem"
...
Config.ssids = ['govroam']
Config.del_ssids = ['govroam']
Config.servers = ['DNS:PKI Doetinchem']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
