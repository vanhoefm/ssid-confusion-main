...
Config.instname = "RIDGWAY"
Config.profilename = "RSW"
...
Config.server_match = "clearpass.domain.local"
...
Config.ssids = ['RSW']
Config.del_ssids = []
Config.servers = ['DNS:clearpass.domain.local']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

PO6zA5pdK30sP4dHpINL5In6doKnsYkNSVrDkA3f8rW53lOC
-----END CERTIFICATE-----
"""
#run_installer()
