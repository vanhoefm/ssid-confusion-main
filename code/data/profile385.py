...
Config.instname = "SFTWales-Wi-Fi"
Config.profilename = ""
...
Config.server_match = "radius.private.sftwales.com"
...
Config.ssids = ['SFTWales-Wi-Fi']
Config.del_ssids = []
Config.servers = ['DNS:radius.private.sftwales.com']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

zwWTzqCyB5EiqSZMTV57F624KQnr9YbIM01uJsG2p4/7r6/CuLz/6aC2
-----END CERTIFICATE-----
"""
#run_installer()
