...
Config.instname = "IETF"
Config.profilename = "IETF"
Config.url = "https://tickets.meeting.ietf.org/"
Config.email = "your local Enterprise Wi-Fi support"
Config.title = "eduroam CAT"
Config.server_match = "services.meeting.ietf.org"
...
Config.ssids = ['ietf', 'ietf-2.4ONLY', 'ietf-nat64', 'ietf-v6ONLY']
Config.del_ssids = []
Config.servers = ['DNS:services.meeting.ietf.org']
Config.use_other_tls_id = False
Config.tou = """Note Well
