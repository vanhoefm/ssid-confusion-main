...
Config.user_realm = "ozon.ru"
Config.ssids = ['OZON_WIFI_LAN']
Config.del_ssids = []
Config.servers = ['DNS:ca.o3.ru']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
