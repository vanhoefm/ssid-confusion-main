...
Config.instname = "Tournesols Chavannes"
Config.profilename = "Tournesols Chavannes"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "tournesols.chavannes@gmail.com"
Config.title = "eduroam CAT"
Config.server_match = "alix"
...
Config.ssids = ['Tournesols']
Config.del_ssids = []
Config.servers = ['DNS:alix']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

o+pX8xxAAAC7HrmXlPIocQ5SY3Uykdd/ZssBrN4y0WPO7vPVv78Gj9cA
-----END CERTIFICATE-----
"""
#run_installer()
