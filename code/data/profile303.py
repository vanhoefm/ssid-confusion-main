...
Config.instname = "Institut Nicolau Copèrnic"
Config.profilename = "Alumnat ESO i BATX"
Config.url = "https://www.copernic.cat"
Config.email = "your local Enterprise Wi-Fi support"
Config.title = "eduroam CAT"
Config.server_match = "copernic.cat"
...
Config.ssids = ['eso_batx']
Config.del_ssids = ['configuracio']
Config.servers = ['DNS:auth1.copernic.cat', 'DNS:auth2.copernic.cat']
Config.use_other_tls_id = False
Config.tou = """En accedir a les xarxes sense fils de l'Institut Nicolau Copèrnic, confirma que ha llegit i està d'acord amb les presents condicions.
El servei de xarxa sense fils és proporcionat per l'Institut Nicolau Copèrnic. L'incompliment de les condicions d'ús, a més de les corresponents sancions, pot comportar que el seu accés a la xarxa sigui bloquejat, suspès o finalitzat en qualsevol moment. 
La seva activitat a través de la xarxa sense fils serà monitoritzada per a la generació d'informes i per a la verificació del bon ús dels recursos TIC del centre. Aquesta monitorització consistirà en el registre de connexions, adreces i recursos web visitats (usuari, data i hora, URL i ample de banda consumit). No es registrarà cap dada personal ni el contingut de la informació transmesa a través de la xarxa sense fils.
Vostè confirma que no farà servir la xarxa sense fils per cap finalitat il·lícita i que pren total responsabilitat dels seus actes.
El seu compte d'usuari és personal i intransferible, només pot ser utilitzat en un únic dispositiu de manera simultània i només és vàlid per connectar a la xarxa sense fils assignada."""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
