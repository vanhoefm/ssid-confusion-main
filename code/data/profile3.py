...
Config.instname = "U*JUMP FTL Spaceship Rental, Inc."
Config.profilename = "Pilots"
Config.url = "helpdesk@u-jump.example"
Config.email = "help@u-jump.example"
Config.title = "eduroam CAT"
Config.server_match = "radius.u-jump.example"
...
Config.user_realm = "u-jump.example"
Config.ssids = ['FTL', 'SubLightSpeed']
Config.del_ssids = []
Config.servers = ['DNS:radius.u-jump.example']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@u-jump.example"
Config.tou = """Only use the network for legal things. Shame on you if you do otherwise!
"""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
