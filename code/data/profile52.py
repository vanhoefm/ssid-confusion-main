...
Config.instname = "cPanel Inc."
Config.profilename = "cPanel Inc. 802.1x"
Config.url = "https://cpanel.com/"
Config.email = "systems@cpanel.net"
Config.title = "eduroam CAT"
Config.server_match = "cPanel Inc. 802.1x"
...
Config.ssids = ['2550 Wifi']
Config.del_ssids = []
Config.servers = ['DNS:cPanel Inc. 802.1x']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
