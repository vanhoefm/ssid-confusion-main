...
Config.instname = "Morocco Campus Connecte"
Config.profilename = "Campus Connecte"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "Hamza.Aanaou@waroom.ma"
Config.title = "eduroam CAT"
Config.server_match = "secure.ac.ma"
...
Config.user_realm = "ac.ma"
Config.ssids = ['Campus Connecte']
Config.del_ssids = []
Config.servers = ['DNS:secure.uae.ac.ma', 'DNS:secure.uca.ac.ma', 'DNS:secure.ucd.ac.ma', 'DNS:secure.uh1.ac.ma', 'DNS:secure.uit.ac.ma', 'DNS:secure.uiz.ac.ma', 'DNS:secure.um5.ac.ma', 'DNS:secure.umi.ac.ma', 'DNS:secure.ump.ac.ma', 'DNS:secure.univh2c.ac.ma', 'DNS:secure.usmba.ac.ma', 'DNS:secure.usms.ac.ma']
