...
Config.instname = "summerhays.net"
Config.profilename = "summerhays.net"
Config.url = "summerhays.net"
Config.email = "david@summerhays.net"
Config.title = "eduroam CAT"
Config.server_match = "summerhays.net"
...
Config.user_realm = "summerhays.net"
Config.ssids = ['OhMyWifiGT2']
Config.del_ssids = []
Config.servers = ['DNS:summerhays.net']
Config.use_other_tls_id = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
