...
Config.instname = "Gilford"
Config.profilename = "Guest"
Config.url = "111-111-1111"
Config.email = "guest@support.com"
Config.title = "eduroam CAT"
Config.server_match = "talkitup.auth0.com"
...
Config.ssids = ['Guest']
Config.del_ssids = []
Config.servers = ['DNS:talkitup.auth0.com']
Config.use_other_tls_id = False
Config.tou = """terms of ouse filesadfffffffdsa  sd fa sd fas d fa sd fa sdf asd fa sd fa sdfasdfasd f asd fasdfa sdf asdfasdfas dfa sdf asfd asd fa sdf as df as df a sd fa sd f asd f"""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
