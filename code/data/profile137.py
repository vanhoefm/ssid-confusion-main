...
Config.instname = "Ashesi University College"
Config.profilename = "Ashesi University"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "itsupport@ashesi.edu.gh"
Config.title = "eduroam CAT"
Config.server_match = "ash-ds-00111.ashesi.local"
...
Config.user_realm = "ashesi.edu.gh"
Config.ssids = ['Ashesi.X']
Config.del_ssids = ['AshesiAir']
Config.servers = ['DNS:ash-ds-00111.ashesi.local']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

ZNOOXSoKBIxSD3NsXmz994AiVhwJSfSIQ4qCkQyTQnONKJAoLSgVNQaT
-----END CERTIFICATE-----
"""
#run_installer()
