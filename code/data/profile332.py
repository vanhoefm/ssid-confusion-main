...
Config.instname = "Gymnasium Kirchenfeld"
Config.profilename = "gymKIRCHENFELD"
Config.url = " \
    ""https://www.gymkirchenfeld.ch/organisation/informatikdienst/"
Config.email = "support@gymkirchenfeld.ch"
Config.title = "eduroam CAT"
Config.server_match = "kinet.ch"
...
Config.user_realm = "kinet.ch"
Config.ssids = ['gymKIRCHENFELD']
Config.del_ssids = []
Config.servers = ['DNS:node1.radius.kinet.ch', 'DNS:node2.radius.kinet.ch', 'DNS:node3.radius.kinet.ch', 'DNS:node4.radius.kinet.ch', 'DNS:radius.ad.kinet.ch', 'DNS:radius.kinet.ch', 'DNS:radius1.ad.kinet.ch', 'DNS:radius2.ad.kinet.ch']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@kinet.ch"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
