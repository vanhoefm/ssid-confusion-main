...
Config.instname = "ABC Christian Academy Faculty Wifi"
Config.profilename = "ABCCA Faculty home office"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "lloydt@africanbiblecolleges.net	"
Config.title = "eduroam CAT"
Config.server_match = "Radius.abcmalawi"
...
Config.user_realm = "africanbiblecolleges.net"
Config.ssids = ['ABCCA-Faculty']
Config.del_ssids = []
Config.servers = ['DNS:Radius.abcmalawi']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@africanbiblecolleges.net"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
