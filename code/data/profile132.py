...
Config.instname = "Academy Consult München e.V."
Config.profilename = "Academy Consult"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "helpdesk@academyconsult.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.win.acintern.de"
...
Config.user_realm = "academyconsult.de"
Config.ssids = ['Academy Consult']
Config.del_ssids = []
Config.servers = ['DNS:radius.win.acintern.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@academyconsult.de"
Config.tou = ""
