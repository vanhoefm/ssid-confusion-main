...
Config.instname = "Maroc Campus Connecte"
Config.profilename = "Maroc Campus Connecte"
Config.url = "https://www.men.gov.ma/"
Config.email = "m.izallalen@3gcom-int.com"
...
Config.ssids = ['Campus Connecte']
Config.del_ssids = []
Config.servers = ['DNS:*', 'DNS:freeradius', 'DNS:radius.example.com', 'DNS:secure.uae.ac.ma', 'DNS:secure.uca.ac.ma', 'DNS:secure.ucd.ac.ma', 'DNS:secure.uh1.ac.ma', 'DNS:secure.uit.ac.ma', 'DNS:secure.uiz.ac.ma', 'DNS:secure.um5.ac.ma', 'DNS:secure.umi.ac.ma', 'DNS:secure.ump.ac.ma', 'DNS:secure.univh2c.ac.ma', 'DNS:secure.univh2c.ma', 'DNS:secure.usmba.ac.ma', 'DNS:secure.usms.ac.ma']
...
aG9yaXR5ghRwMsNyn8Uc1+PbvHl+WgCVaNBcyjAPBgNVHRMBAf8EBTADAQH/MA0G
...
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----
MIIEtDCCA5ygAwIBAgIUQI14vmDnKU/ZFe9nwaf/pVgsa0kwDQYJKoZIhvcNAQEL
