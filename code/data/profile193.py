...
Config.instname = "Artevelde Hogeschool Gent"
Config.profilename = ""
Config.url = "https://www.arteveldehogeschool.be/login"
Config.email = "servicedesk@arteveldehs.be"
Config.title = "eduroam CAT"
Config.server_match = "wifi.arteveldehs.be"
...
Config.del_ssids = []
Config.servers = ['DNS:wifi.arteveldehs.be']
