...
Config.instname = "ABC Community Clinic Staff Wifi"
Config.profilename = "ABC Community Clinic Wifi"
Config.url = "your local Enterprise Wi-Fi support page"
Config.email = "lloydt@abccommunityclinic.net"
...
Config.user_realm = "abccommunityclinic.net"
Config.ssids = ['ABC-Clinic']
Config.del_ssids = []
Config.servers = ['DNS:radius.abcmalawi']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@abccommunityclinic.net"
