...
Config.instname = "ABC Masters Students Wifi"
Config.profilename = "ABC-Masters WiFi"
...
Config.user_realm = "abcmalawistudent.net"
Config.ssids = ['ABC-Masters']
Config.del_ssids = []
Config.servers = ['DNS:Radius.abcmalawi']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@abcmalawistudent.net"
