...
Config.instname = "Leibniz-Institute for Astrophysics Potsdam"
Config.profilename = "AIP-Eduroam"
Config.url = "https://www.aip.de/de/institut/facilities/it-service"
Config.email = "support@aip.de"
Config.title = "eduroam CAT"
Config.server_match = "rex.astrophysik.aip.de"
...
Config.del_ssids = []
Config.servers = ['DNS:rex.astrophysik.aip.de']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
