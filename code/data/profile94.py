...
Config.instname = "Quantic Telecom"
Config.profilename = "Quantic Telecom"
Config.url = "https://www.quantic-telecom.net/assistance"
Config.email = "helpdesk@quantic-telecom.net"
Config.title = "eduroam CAT"
Config.server_match = "radius.rennes.quantic-telecom.net"
...
Config.ssids = ['Quantic Telecom - Securise']
Config.del_ssids = ['Quantic Telecom - Acces gratuit']
Config.servers = ['DNS:radius.rennes.quantic-telecom.net']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

7s33MJfsA63f2ONtTw0+ye0N6fKFVroS
-----END CERTIFICATE-----
"""
#run_installer()
