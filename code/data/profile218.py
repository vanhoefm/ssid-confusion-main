...
Config.instname = "Technion Institute"
Config.profilename = "TechSec"
Config.url = " \
    ""https://cis.technion.ac.il/kb/faq/communication/wirelesscomm/campus/techsec/"
Config.email = "hd@technion.ac.il"
Config.title = "eduroam CAT"
Config.server_match = "il"
...
Config.del_ssids = []
Config.servers = ['DNS:.*\.technion\.ac\.il', 'DNS:eduroam.technion.ac.il']
