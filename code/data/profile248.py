...
Config.instname = "BLIS"
Config.profilename = "BLIS-STAFF"
Config.url = "http://www.blisankara.org"
Config.email = "ithelpdesk@blisankara.org"
Config.title = "eduroam CAT"
Config.server_match = "BLIS Server Certificate"
...
Config.user_realm = "blisankara.org"
Config.ssids = ['BLIS-STAFF']
Config.del_ssids = []
Config.servers = ['DNS:"BLIS Server Certificate"']
Config.use_other_tls_id = False
Config.tou = """Disclaimer....
bla bla bla...
"""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
