...
Config.instname = "agdsn-tharandt"
Config.profilename = "AG DSN Tharandt"
Config.url = "https://agdsn.de"
Config.email = "support@agdsn.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.agdsn.de"
...
Config.user_realm = "radius.agdsn.de"
Config.ssids = ['agdsn-tharandt']
Config.del_ssids = []
Config.servers = ['DNS:radius.agdsn.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@radius.agdsn.de"
Config.tou = """# AG DSN Wifi Tharandt
...
Please send your objection to support@agdsn.de
