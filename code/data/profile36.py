...
Config.instname = "IMDEA Software"
Config.profilename = ""
Config.url = "http://software.imdea.org/intranet/tickets/"
Config.email = "it-support@software.imdea.org"
Config.title = "eduroam CAT"
Config.server_match = "radius.imdea.so"
...
Config.ssids = ['IMDEA Software']
Config.del_ssids = []
Config.servers = ['DNS:radius.imdea.so']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
#run_installer()
